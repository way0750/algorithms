...
//making the tree from existing tree:
//parallel traversing?
//or maybe don't need to create a new tree first
//create nodes/smaller trees from bottom first then joined them all the way up to the top most node then return?
//recursion?
//recursive case: have child/children
//how to break smaller: go through the child list one by one
//what to return: a new (smaller?)tree:
//what to do about the return?
//  a node/tree the children list?
//
...
Tree.prototype.map = function (callback) {
  ...
  let newParent = new Tree(callback(this.value));
  console.log(newParent);
  newParent.children = this.children.map( (child) => {
